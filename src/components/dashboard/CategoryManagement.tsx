...
export default function CategoryManagement() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (err.response?.status === 400 || err.response?.status === 409 || err.response?.data?.detail?.includes("related")) {
        try {
          ...
          showToast("error", updateErr.response?.data?.detail || "Failed to deactivate category");
        }
      } else {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="group">
                ...
                <input
                  ...
                  className={`w-full border-2 rounded-xl px-4 py-2.5 text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#6750A4]/20 ${
                    formErrors.name 
              ...
              <div className="group">
                ...
                <input
                  ...
                  className="w-full border-2 border-gray-200 bg-gray-50/80 rounded-xl px-4 py-2.5 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-[#6750A4] focus:bg-white focus:ring-2 focus:ring-[#6750A4]/20"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="relative w-full h-full flex flex-col items-center justify-center">
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          const fileInput = document.getElementById("category-icon-upload") as HTMLInputElement;
              ...
              <div className="group">
                ...
                <textarea
                  ...
                  className="w-full border-2 border-gray-200 bg-gray-50/80 rounded-xl px-4 py-3 text-sm transition-all duration-200 focus:outline-none focus:border-[#6750A4] focus:bg-white focus:ring-2 focus:ring-[#6750A4]/20 resize-none"
                  style={{ height: '130px' }}
                />
              </div>
            </div>
                ...
                <div className="flex items-center gap-2">
                  <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium transition-all ${
                    ...
                    <span className={`inline-block w-1.5 h-1.5 rounded-full ${
                      formData.is_active ? "bg-emerald-500 animate-pulse" : "bg-gray-400"
                    }`}></span>
                    {formData.is_active ? "Visible" : "Hidden"}
                  </span>
                  <span className="text-xs text-gray-400">Visible to all companies</span>
                </div>
              </div>
            </div>
          </div>
