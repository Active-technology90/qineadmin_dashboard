          ...
          {step === 'details' ? (
            isReadOnlyBasic ? (
              <div className="flex justify-end">
                <button
                  type="button"
                  onClick={onClose}
                  className="px-4 py-1.5 sm:py-2.5 rounded-lg bg-gray-200 text-gray-700 font-medium hover:bg-gray-300 transition text-sm"
                >
                  Close
                </button>
              </div>
              ...
              <div className="flex flex-row justify-end gap-3">
                <button
                  type="button"
                  onClick={onClose}
                  className="px-4 py-1.5 sm:py-2.5 rounded-lg border border-gray-300 text-gray-700 font-medium hover:bg-gray-50 transition text-sm"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-4 py-1.5 sm:py-2.5 rounded-lg bg-secondary text-white font-medium hover:bg-[#5a448c] transition flex items-center justify-center gap-2 shadow-sm disabled:opacity-50 text-sm"
                >
            ...
            <div className="flex flex-row justify-between gap-3">
              <button
                ...
                className="px-4 py-1.5 sm:py-2.5 rounded-lg border border-gray-300 text-gray-700 font-medium hover:bg-gray-50 transition flex items-center justify-center gap-2 text-sm"
              ...
              <button
                type="button"
                onClick={onClose}
                className="px-4 py-1.5 sm:py-2.5 rounded-lg bg-secondary text-white font-medium hover:bg-secondary-dark transition shadow-sm text-sm"
              >
                Done
              </button>
            </div>
