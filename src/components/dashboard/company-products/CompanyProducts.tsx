      ...
      <div className="px-3 sm:px-5 md:px-6">
          ...
          <div className="flex items-center justify-between">
            ...
            {isSuperAdmin && (
              <button
                ...
                className="py-0.5 lg:py-1.5 px-3.5 rounded-full border-2 border-[#6750A4] bg-transparent text-xs font-medium text-[#6750A4] hover:bg-secondary/5 transition-all flex items-center justify-center gap-1.5 whitespace-nowrap"
              >
                <RefreshCw className="h-2.5 lg:h-3.5 w-2.5 lg:w-3.5 text-[#6750A4]" /> Switch
              </button>
            )}
          </div>
        </div>
        ...
        <div className="hidden lg:flex flex-row justify-end items-center gap-3 mt-3 sm:mt-4 mb-3">
          ...
          {isSuperAdmin && (
            <button
              onClick={clearCompany}
              className="py-1.5 px-3.5 rounded-full border-2 border-[#6750A4] bg-transparent text-xs font-medium text-[#6750A4] hover:bg-secondary/5 transition-all flex items-center justify-center gap-1.5 whitespace-nowrap"
            >
              <RefreshCw className="h-3 lg:h-3.5 w-3 lg:w-3.5 text-[#6750A4]" /> Switch
            </button>
          )}
