...
export default function CompanyManagement() {
  ...
  const steps = useMemo(
    () => [
      {
        id: "basic",
        title: <span className="text-[#674FA3]">Basic Information</span>,
        content: (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 gap-y-5">
            <div>
              ...
              <input
                ...
                className={`w-full border rounded-lg p-2.5 sm:p-3 text-sm sm:text-base transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#674FA3] focus:ring-opacity-30 focus:border-[#674FA3] ${formErrors.name ? "border-red-500" : "border-gray-300"}`}
              />
              {formErrors.name && (
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-lg p-2.5 sm:p-3 text-sm sm:text-base transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#674FA3] focus:ring-opacity-30 focus:border-[#674FA3]"
              />
            </div>
            <div>
              <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1.5">
              ...
              <select
                ...
                className={`w-full border rounded-lg p-2.5 sm:p-3 text-sm sm:text-base transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#674FA3] focus:ring-opacity-30 focus:border-[#674FA3] ${formErrors.category ? "border-red-500" : "border-gray-300"}`}
              >
            ...
            <div>
              ...
              <select
                ...
                className={`w-full border rounded-lg p-2.5 sm:p-3 text-sm sm:text-base transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#674FA3] focus:ring-opacity-30 focus:border-[#674FA3] ${!formData.category ? "bg-gray-100 text-gray-500 cursor-not-allowed" : "bg-white"} ${formErrors.sub_category ? "border-red-500" : "border-gray-300"}`}
            ...
            <div>
              ...
              <select
                ...
                className={`w-full border rounded-lg p-2.5 sm:p-3 text-sm sm:text-base transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#674FA3] focus:ring-opacity-30 focus:border-[#674FA3] ${formErrors.business_type ? "border-red-500" : "border-gray-300"}`}
              >
            ...
            <div>
              ...
              <input
                ...
                className={`w-full border rounded-lg p-2.5 sm:p-3 text-sm sm:text-base font-mono transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#674FA3] focus:ring-opacity-30 focus:border-[#674FA3] ${formErrors.slug ? "border-red-500" : "border-gray-300"}
      ...
      {
        id: "images",
        title: <span className="text-[#674FA3]">Images & Status</span>,
        content: (
          <div className="space-y-8">
            {/* Logo and Cover Image - Side by Side */}
            <div>
              <h4 className="text-sm font-semibold text-gray-800 mb-4 flex items-center gap-2">
                <div className="w-1 h-4 rounded-full bg-gradient-to-b from-[#674FA3] to-[#8B6BB5]"></div>
                Company Images
              </h4>
            ...
            />
                ...
                <div className="flex flex-col h-full">
                  <div className="flex-1">
                    ...
                    <div
                      className="bg-gradient-to-br from-gray-50 to-white rounded-xl border-2 border-dashed border-gray-200 p-3 flex flex-col items-center justify-center transition-all duration-300 hover:border-[#674FA3] hover:bg-gray-50/80 min-h-[140px] sm:min-h-[160px]"
                      style={{ height: "auto" }}
                    >
                      <input
                        type="file"
                      ...
                      {logoPreview ? (
                        <div className="relative w-full h-full flex flex-col items-center justify-center">
                          <div className="relative group/preview">
                            <img
                              src={logoPreview}
                              alt="Logo Preview"
                              className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl object-cover shadow-lg ring-2 ring-[#674FA3]/20"
                            />
                        ...
                        >
                          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-[#674FA3]/10 to-[#674FA3]/5 flex items-center justify-center mb-1.5 transition-all duration-200 group-hover:shadow-md">
                            <svg
                              className="w-5 h-5 sm:w-6 sm:h-6 text-[#674FA3]"
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
                ...
                <div className="flex flex-wrap items-center gap-8">
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <input
                      ...
                      className="h-4 w-4 text-[#674FA3] rounded border-gray-300 focus:ring-[#674FA3] focus:ring-2 cursor-pointer"
                    />
                    <div>
                      <span className="text-sm font-medium text-gray-700 group-hover:text-[#674FA3] transition-colors">
                        Active
                      </span>
      ...
      <div className="p-2  sm:p-4 md:p-4 lg:p-6 space-y-3 sm:space-y-3 md:space-y-4">
        ...
        <div className="pt-1 px-2 sm:pt-3 md:pt-4 flex justify-between items-center gap-3 flex-wrap">
          <div className="min-w-0 flex-1">
            <h2 className="text-base pt-2 sm:text-sm md:text-xl font-bold text-[#674FA3] truncate">
          ...
          {canAddCompany && (
            <button
              ...
              className="bg-[#674FA3] text-white px-4 sm:px-5 py-2 rounded-xl flex items-center gap-2 hover:bg-[#5b4694] transition shadow-sm text-sm sm:text-base flex-shrink-0"
            >
