        ...
        <div className="sticky top-0 z-10 pt-1 pb-2">
          <div className="relative p-1 ">
            <SearchInput
              ...
              className="pr-0 rounded-full  shadow-sm border-[#674FA3] focus:ring-2 focus:ring-[#674FA3]/30"
            />
                    ...
                    <div className="flex-shrink-0">
                      {company.logo ? (
                        <div className="relative">
                          <div className="absolute inset-0 bg-gradient-to-r from-[#674FA3]/20 to-transparent rounded-full blur-sm"></div>
                          <img
                            src={company.logo}
                            alt={company.name}
            ...
            <div>
              ...
              {loading ? (
                <div className="flex items-center gap-2 text-gray-400 text-sm py-2">
                  <div className="animate-spin rounded-full h-4 w-4 border-2 border-[#674FA3] border-t-transparent" />
                  <span>Loading...</span>
                </div>
