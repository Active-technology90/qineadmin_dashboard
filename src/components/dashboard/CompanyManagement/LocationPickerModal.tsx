      ...
      <div className="bg-white w-full h-[100dvh] max-h-[100dvh] rounded-none sm:rounded-2xl md:rounded-3xl md:max-w-4xl md:h-[85vh] md:max-h-[85vh] flex flex-col overflow-hidden shadow-2xl border border-gray-100">
        ...
        <div className="p-4 sm:p-5 border-b border-gray-100 flex items-center justify-between bg-gradient-to-r from-purple-50/50 via-white to-indigo-50/50 shrink-0">
          <div className="flex items-center gap-3 min-w-0 flex-1">
            <div className="p-2.5 bg-gradient-to-br from-[#674FA3]/15 to-[#8B6BB5]/15 rounded-2xl shadow-inner shrink-0">
              <MapPin className="h-5 w-5 text-[#674FA3]" />
            </div>
          ...
          >
            {!leafletLoaded ? (
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-white z-10 gap-3">
                <Loader2 className="h-8 w-8 text-[#674FA3] animate-spin" />
            ...
            {leafletLoaded && (
              ...
              >
                {detecting ? (
                  <Loader2 className="h-4 w-4 animate-spin text-[#674FA3]" />
                ) : (
                  <Navigation className="h-4 w-4 text-[#674FA3]" />
                )}
          ...
          <div className="flex-1 border-t md:border-t-0 md:border-l border-gray-100 flex flex-col bg-gradient-to-b from-white to-gray-50/50 md:w-80 md:flex-none">
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-4">
              ...
              <form onSubmit={handleSearch} className="relative">
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 text-xs sm:text-sm border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-[#674FA3]/20 focus:border-[#674FA3] transition-all bg-white shadow-sm"
                />
                <Search className="absolute left-3.5 top-3.5 h-3.5 w-3.5 text-gray-400" />
                <button
                  type="submit"
                  disabled={searching}
                  className="absolute right-2.5 top-2 p-1.5 bg-gray-100 hover:bg-[#674FA3] text-gray-500 hover:text-white rounded-lg transition-all"
                >
                  {searching ? (
              ...
              <div className="bg-gradient-to-br from-purple-50/60 to-indigo-50/60 p-4 rounded-2xl border border-purple-100/50 space-y-3 shadow-inner">
                <h4 className="text-[10px] sm:text-xs text-[#674FA3] font-bold uppercase tracking-wider">
                  Target Coordinates
                </h4>
            ...
            <div className="p-4 sm:p-5 border-t border-gray-100 flex flex-col sm:flex-row gap-3 shrink-0 bg-white/80 backdrop-blur-sm">
              ...
              <button
                type="button"
                onClick={handleSave}
                className="flex-1 py-3 bg-[#674FA3] hover:bg-[#5b4694] text-white rounded-xl text-xs sm:text-sm font-bold shadow-lg shadow-purple-100 active:scale-[0.98] transition-all flex items-center justify-center gap-1.5"
              >
