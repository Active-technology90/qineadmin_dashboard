...
const ModalActions: React.FC<{
  ...
  <div className="flex flex-row sm:flex-row justify-end gap-2 xs:gap-3">
    ...
    <button
      onClick={onEdit}
      className="w-full sm:w-auto px-4 py-2 xs:py-2.5 rounded-lg bg-[#674FA3] text-white text-xs xs:text-sm font-medium hover:bg-[#5a448c] transition-all duration-200 shadow-sm"
    >
