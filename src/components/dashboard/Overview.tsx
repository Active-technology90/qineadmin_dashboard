    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {cards.map((card, idx) => (
          ...
          >
            <div className={`${card.bgLight} w-12 h-12 rounded-xl flex items-center justify-center mb-4`}>
            ...
            <div className="flex items-baseline justify-between mt-2">
              ...
              {card.trend !== undefined && (
                <span className={`flex items-center text-xs font-medium ${card.trend >= 0 ? 'text-emerald-600' : 'text-red-600'}`}>
