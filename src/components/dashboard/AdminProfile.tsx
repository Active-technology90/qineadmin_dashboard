    ...
    <div className="w-full min-h-screen bg-gray-50 px-4 sm:px-6 md:px-8 py-4 sm:py-6 md:py-8 lg:py-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-100">
          {/* <div
          className="relative h-32 bg-gradient-to-r from-[#674FA3] to-[#8B6BB4]"
          style={{
              ...
              <div className="hidden sm:block">
                <div className="flex gap-1">
                  ...
                  >
                    Edit Profile
                    {activeForm === "profile" && (
                      <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-[#674FA3] rounded-full" />
                    )}
                  </button>
                  <button
                ...
                <div className="flex gap-2 p-1 bg-gray-100 rounded-xl">
                  <button
                    ...
                    className={`flex-1 px-3 py-2 text-xs font-medium rounded-lg transition-all duration-200 ${
                      activeForm === "profile"
                        ? "bg-white text-[#674FA3] shadow-sm"
              ...
              <div className="mt-4 sm:mt-5 md:mt-6 space-y-4 sm:space-y-5">
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <div className="relative">
                          ...
                          <input
                            {...field}
                            className={`w-full pl-8 sm:pl-9 pr-3 py-2 sm:py-2.5 text-sm sm:text-base border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#674FA3] transition ${
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <div className="relative">
                          ...
                          <input
                            {...field}
                            className="w-full pl-8 sm:pl-9 pr-3 py-2 sm:py-2.5 text-sm sm:text-base border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#674FA3] focus:border-transparent transition"
                      ...
                      render={({ field }) => (
                        <div className="relative">
                          ...
                          <input
                            {...field}
                            type="email"
                            className="w-full pl-8 sm:pl-9 pr-3 py-2 sm:py-2.5 text-sm sm:text-base border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#674FA3] focus:border-transparent transition text-gray-900"
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-2.5 bg-[#674FA3] text-white rounded-xl font-medium hover:bg-[#5a3d8c] transition shadow-sm disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
                  >
                ...
                <div className="max-w-full sm:max-w-md space-y-4 sm:space-y-5">
                      ...
                      render={({ field }) => (
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full pl-8 sm:pl-9 pr-9 sm:pr-10 py-2 sm:py-2.5 text-sm sm:text-base border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#674FA3] transition ${
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      className="w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-2.5 bg-[#674FA3] text-white rounded-xl font-medium hover:bg-[#5a3d8c] transition shadow-sm disabled:opacity-50 text-sm sm:text-base"
                    >
              ...
              <div className="mt-4 sm:mt-5 md:mt-6">
                <div className="flex flex-row items-center justify-between mb-3 sm:mb-4 gap-2">
                  ...
                  <span className="text-[9px] sm:text-xs bg-amber-500 text-white px-1.5 sm:px-3 py-0.5 rounded-full whitespace-nowrap shadow-sm">
                    ...
                    {user?.memberships?.length === 1 ? "company" : "companies"}
                  </span>
                </div>
                      ...
                      return (
                        <div
                          ...
                          className={`relative bg-white border rounded-xl p-3 sm:p-4 cursor-pointer transition-all duration-200 group ${
                            isActive
                              ? "border-[#674FA3] shadow-md ring-1 ring-[#674FA3]/20"
                        ...
                        >
                          <div className="flex items-start justify-between">
                            <div className="flex items-center gap-3">
                              <div
                                className={`w-10 h-10 sm:w-12 sm:h-12 rounded-2xl flex items-center justify-center transition-all duration-300 overflow-hidden shadow-md flex-shrink-0 ${
                                  isActive
                                    ? "bg-gradient-to-br from-[#674FA3] to-purple-700 ring-2 ring-[#674FA3]/30"
                                    : "bg-gradient-to-br from-gray-100 to-gray-200 group-hover:from-[#674FA3]/10 group-hover:to-purple-100"
                                }`}
                              >
                                {(() => {
                                  ...
                                  return (
                                    <Building
                                      className={`h-5 w-5 sm:h-6 sm:w-6 transition-all duration-300 ${
                                        isActive
                                          ? "text-white"
                                          : "text-gray-500 group-hover:text-[#674FA3]"
                                      }`}
                                    />
                                  );
                                })()}
                              ...
                              <div className="flex-1 min-w-0">
                                <p
                                  className={`font-semibold transition-all duration-300 break-words ${
                                    isActive
                                      ? "text-[#674FA3] text-base sm:text-lg"
                                      : "text-gray-800 group-hover:text-[#674FA3] text-sm sm:text-base"
                                  }`}
                                >
                            ...
                            <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0 ml-2">
                              ...
                              {isActive ? (
                                <CheckCircle className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-[#674FA3]" />
                              ) : (
                                <ArrowRight className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-gray-300 group-hover:text-[#674FA3] transition-colors" />
                              )}
                            </div>
                          </div>
                        </div>
